                ...
                <div class="mb-lg-0">
                    <div class="">
                        <div class="item2-gl">
                            ...
                            <?php
                            if($emlak_ilanlar_doping && $emlak_ilanlar_doping->rowCount()){
                                        ...
                                        <div class="d-md-flex">
                                            <div class="item-card9-img">
                                                <div class="item-card9-imgs kategori-list-img">
                                                    <a href="<?php echo $emlak["seo"]; ?>-<?php echo $emlak["emlakno"]; ?>-ilan-<?php echo $emlak["id"]; ?>">
                                            ...
                                            <div class="card border-0 mb-0 pl-lg-2">
                            ...
                            <?php if ($emlak_ilanlar_doping && $emlak_ilanlar_doping->rowCount()): ?>
                                        ...
                                        <?php if (ilanYayinSuresi($uye_id)>tarihFarki($emlak["eklemetarihi"], date("Y-m-d"))): ?>  
                                            ...
                                            <div class="card mb-3 overflow-hidden kategori-ilan-liste">
                                                ...
                                                <div class="d-md-flex">
                                                    ...
                                                    <div class="card border-0 mb-0 m-2 pl-lg-2 box-shadow-0 <?php if (dopingAdi($ilan_id, "renkli_bold")>0 AND $emlak["doping_onay"] == 1): ?> badge-success <?php endif; ?>">
                                                        <div class="card-body pl-1 pb-0">
                                                            ...
                                                            <h4 class="mb-5 liste-baslik"><strong><a class="<?php if (dopingAdi($ilan_id, "renkli_bold")>0 AND $emlak["doping_onay"] == 1): ?> font-weight-bold text-primary <?php endif; ?>" href="<?php echo $emlak["seo"]; ?>-<?php echo $emlak["emlakno"]; ?>-ilan-<?php echo $emlak["id"]; ?>"><?php echo $emlak["baslik"]; ?></a></strong></h4>
                                                            <h4 class="mb-3">
                                                    ...
                                                    <div class="d-block d-md-none d-sm-none d-xl-none">
                                                        <div class="row pl-3 pr-3 pt-3 pb-3">
                                                            <div class="col-12">
                                                                <a class="btn btn-success btn-lg btn-block" href="tel:<?php echo $ekleyen["tel"]; ?>"><i class="fa fa-phone"></i> <strong>TELEFONU ARA</strong></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        foreach ($emlak_ilanlar as $liste) {
                                            ...
                                            <?php if (ilanYayinSuresi($uye_id)>tarihFarki($liste["eklemetarihi"], date("Y-m-d"))): ?>
                                                <div class="col-lg-6 col-md-12 col-xl-4 mb-3">
                                                    ...
                                                    <?php $favori = $vt->query("SELECT * FROM favoriler WHERE uye_id = '{$_SESSION["id"]}' AND ilan_id = '{$liste["id"]}' ")->fetch(); ?>
                                                    <?php if(!$_SESSION["uyelogin"]) { ?>
                                                    <a href="#" data-toggle="modal" id="girisKontrol3<?php echo $liste["id"] ?>" class="favori-ekle" style="">
                                                        <i class="fa fa-heart-o fa-lg"></i>
                                                    </a>
                                                    <?php } else { ?>
                                                    <a href="#" id="favEkle3<?php echo $liste["id"] ?>" data-toggle="modal" class="favori-ekle" style="display:<?php if ($favori) { ?>none<?php } ?>">
                                                        <i class="fa fa-heart-o fa-lg"></i>
                                                    </a>
                                                    <?php } ?>
                                                    <a href="#" id="favCikar3<?php echo $liste["id"] ?>" data-toggle="modal" class="favori-cikar" style="display:<?php if (!$favori) { ?>none<?php } ?>">
                                                        <i class="fa fa-heart fa-lg"></i>
                                                    </a> 
                                                    <script> 
                                                    $('#girisKontrol3<?php echo $liste["id"] ?>').click(function ilanId(e){  
                                                        alert('Favorilere ekleyebilmeniz için lütfen üye girişi yapınız.');
                                                        window.location.href = '<?php echo $ayar["site_url"] ?>giris-yap';
                                                    });
                                                    $('#favEkle3<?php echo $liste["id"] ?>').click(function ilanId(e){  
                                                        
                                                        $.post("index.php?do=ajax_favori&favori=ekle&ilanId=<?php echo $liste["id"] ?>&uyeId=<?php echo $_SESSION["id"] ?>",function(data){
                                                            $('#gosterx').html(data);
                                                        }); 
                                                        
                                                        
                                                        $('#favEkle3<?php echo $liste["id"] ?>').css({ 'display': 'none' }); 
                                                        $('#favCikar3<?php echo $liste["id"] ?>').css({ 'display': 'block' }); 
                                            			
                                                    });
                                                    $('#favCikar3<?php echo $liste["id"] ?>').click(function(){ 
                                                        
                                                        $.post("index.php?do=ajax_favori&favori=sil&ilanId=<?php echo $liste["id"] ?>&uyeId=<?php echo $_SESSION["id"] ?>", function(data){
                                                            $("#gosterx").html(data);
                                                        }); 
                                                         
                                                        $('#favEkle3<?php echo $liste["id"] ?>').css({ 'display': 'block' }); 
                                                        $('#favCikar3<?php echo $liste["id"] ?>').css({ 'display': 'none' });  
