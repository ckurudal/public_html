...
<div class="container-fluid" style="background: url(https://www.bookingcore.org/uploads/demo/news/news-banner.jpg); padding: 75px 0; margin: -20px 0 40px 0; border-bottom: 1px solid #ddd; background-size: cover; background-repeat: no-repeat; background-position: center center; color: #fff;">
    <div class="container">
        <h1>Haberler</h1> 
    </div>
                            ...
                            <div class="row no-gutters haber-list">
                                <div class="col-xl-4 col-lg-12 col-md-12">
                                    <div class="item7-card-img">
                                        <a href="/<?=$bsayfa["seo"];?>-haber-<?=$bsayfa["id"];?>"></a> 
                                        <?php if ($bsayfa["resim"] == "") { ?>
                                ...
                                <div class="col-xl-8 col-lg-12 col-md-12">
                                    <div class="card-body">
                                        <div class="item7-card-desc d-flex mb-1">
                                            <a href="/<?=$bsayfa["seo"];?>-haber-<?=$bsayfa["id"];?>" class="text-muted">
                                                <i class="fa fa-calendar-o text-muted mr-2"></i><?=$bsayfa["tarih"];?>
                                            </a>
                                        </div>
                                        <a href="/<?=$bsayfa["seo"];?>-haber-<?=$bsayfa["id"];?>" class="text-dark"><h4 class="font-weight-semibold mb-4"><?=$bsayfa["baslik"];?></h4></a>
                                        <p class=""><?=substr($bsayfa["icerik"], 0, 300);?>...</p>
                                        <a href="/<?=$bsayfa["seo"];?>-haber-<?=$bsayfa["id"];?>" class="btn btn-primary btn-sm">DEVAMINI OKU<i class="fa fa-angle-right ml-3"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-12 mb-5">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Haber Kategorileri</h3> </div>
