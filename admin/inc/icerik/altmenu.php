	...
	<section class="content">
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title"> <i class="fa fa-plus"></i> Alt Menü Ekleme </h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body" style="">
				<div class="form-horizontal">
					...
					<div class="form-group">
					  <label class="col-sm-2 control-label">Alt Menü Seç:</label>
					  <div class="col-sm-10">
						<?php
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<section class="content">
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title"> <i class="fa fa-th"></i> Alt Menü Düzenle </h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body" style="">
				<div class="form-horizontal">
				...
				<table id="example1" class="table table-bordered dataTable" colspan="5" role="grid" aria-describedby="example1_info">
				    <thead>
				        <tr>
				            ...
				            <td style="width:0.1%;"> Alt Menü </td>
				    ...
				    <tbody>
							...
							<tr>
								...
								<th class="text-center" style="width: 10px; white-space: nowrap;">
									<a href="index.php?do=islem&icerik=altmenu&islem=duzenle&id=<?=$akat['id']?>" title="Düzenle" class="btn btn-primary btn-xs btn-blo ck">
										<i class="fa fa-pencil"></i> Düzenle
									</a>
									<?php
										if ($akat["durum"] == "0") {
									?>
									<a href="index.php?do=islem&icerik=altmenu&islem=liste&durum=1&id=<?=$akat['id']?>" title="Yayından Kaldır" class="btn btn-warning btn-xs btn-b lock">
										<i class="fa fa-close"></i> Pasif Et
									</a>
									<?php } else if ($akat["durum"] == "1"){ ?>
									<a href="index.php?do=islem&icerik=altmenu&islem=liste&durum=0&id=<?=$akat['id']?>" title="Yayınla" class="btn btn-success btn-xs btn-bl ock">
									  ...
									  <div class="modal-dialog">
										<div class="modal-content">
										  ...
										  <div class="modal-body">
											<h5 class="alert alert-info"><i class="fa fa-bullhorn"></i><strong> UYARI: </strong> Eğer bir <strong>[ Ana Menü ]</strong> ya da <strong>Alt Menü</strong> silerseniz. Alt menülerde silinecektir!</h5>
										  ...
										  <div class="modal-footer">
											...
											<a href="index.php?do=islem&icerik=altmenu&islem=liste&hareket=sil&id=<?=$akat['id']?>" class="btn btn-danger"> Onaylıyorum Sil <i class="fa fa-trash"></i> </a>
										  </div>
										</div>
									  </div>
									</div>
