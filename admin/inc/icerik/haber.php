	...
	<section class="content"> 
		<div class="box"> 
			<div class="box-header with-border">
				<h3 class="box-title"> <i class="fa fa-plus"></i> Yeni Haber Ekleme </h3>
			</div>
			<!-- /.box-header -->
		...
		<div class="box"> 
			<div class="box-footer">
				<button type="submit" class="btn btn-success btn-lg pull-right" name="haberekle"> <i class="fa fa-check"></i> Yeni Ekle </button>
			 </div> 
		</div> 
	</section>
</form>
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<section class="content"> 
		<div class="box"> 
			<div class="box-header with-border">
				<h3 class="box-title"> <i class="fa fa-edit"></i> Haber Düzenleme </h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body" style="">
				<div class="form-horizontal">
					  ...
					  <div class="col-sm-10"> 
						<select class="form-control select2" name="kategori">
							...
							<?php 
								if (!$s["kategori"] == 0) {
							?>
							<option value="<?=$sfkadi["id"];?>"><?=$sfkadi["baslik"];?></option>
							<?php } ?>
							<?php 
								if ($s["kategori"] == 0) {
							?>
		...
		<div class="box"> 
			<div class="box-footer">
				<button type="submit" class="btn btn-primary btn-lg pull-right" name="haberkaydet"> <i class="fa fa-check"></i> Kaydet </button>
			 </div> 
		</div> 
	</section>
</form>
...
<section class="content">
	...
	<a href="index.php?do=islem&icerik=haber&islem=ekle" class="btn btn-lg bt-xs btn-success">
			    	...
			    	<tbody>
			    		...
			    		<tr>
				    		...
				    		<th class="text-center">
				    			<a href="index.php?do=islem&icerik=haber&islem=duzenle&id=<?=$sliste['id']?>" title="Düzenle" class="btn btn-primary btn-xs btn-block">
									<i class="fa fa-pencil"></i> Düzenle
								</a>
								<?php 
									if ($sliste["durum"] == "0") {
								?>
								<a href="index.php?do=islem&icerik=haber&islem=liste&durum=1&id=<?=$sliste['id']?>" title="Yayından Kaldır" class="btn btn-warning btn-xs btn-block">
									<i class="fa fa-close"></i> Pasif Yap
								</a>
								<?php } else if ($sliste["durum"] == "1"){ ?>
								<a href="index.php?do=islem&icerik=haber&islem=liste&durum=0&id=<?=$sliste['id']?>" title="Yayınla" class="btn btn-success btn-xs btn-block">
									<i class="fa fa-check"></i> Akfit Et
								</a>
								<?php } ?> 
								  ...
								  <div class="modal-dialog">
									<div class="modal-content">
									  ...
									  <div class="modal-body">
										<h4><strong> "<?=$sliste["baslik"]?>" </strong> isimli haber silinecektir. İşlemi onaylıyor musunuz ?</h4>
									  </div>
									  <div class="modal-footer">
										<a href="#" class="btn btn-default" data-dismiss="modal"> Hayır </a>
										<a href="index.php?do=islem&icerik=haber&islem=liste&hareket=sil&id=<?=$sliste['id']?>" class="btn btn-danger"> Onaylıyorum Sil <i class="fa fa-trash"></i> </a>
									  </div>
									</div> 
								  </div> 
								</div>
