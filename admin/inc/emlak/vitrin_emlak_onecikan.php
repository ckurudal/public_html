		 ...
		 <div class="bo x"> 
			<div class="box-bo dy table-responsive">  
				<?php  
					// vitrin guncelle  
					if ($vitrin == "onay") { 
						$anavitrin = mysql_query("update emlak_ilan set onecikan = '0' where id = '$id'"); 
						onay();
					} 
				?> 
                <table id="example1" class="table table-bordered dataTable" colspan="5" role="grid" aria-describedby="example1_info">
                    ...
                    <tbody> 
                    <?php 
                    	$ilanlar=mysql_query("SELECT * FROM emlak_ilan where onecikan = '1' order by id DESC");
                    ...
                    <tr>
                    	...
                    	<th>
							<a href="index.php?do=islem&emlak=emlak_onecikan&vitrin=onay&id=<?=$ilan["id"];?>" class="btn btn-default btn-xs btn-block" style="text-align: left;">
