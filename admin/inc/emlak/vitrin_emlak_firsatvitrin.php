		 ...
		 <div class="bo x"> 
			<div class="box-bod y table-responsive">  
				<?php  
					// vitrin guncelle  
					if ($vitrin == "onay") { 
						$anavitrin = mysql_query("update emlak_ilan set firsatvitrin = '0' where id = '$id'"); 
						onay();
					} 
				?> 
                <table id="example1" class="table table-bordered dataTable" colspan="5" role="grid" aria-describedby="example1_info">
                    ...
                    <tbody> 
                    <?php 
                    	$ilanlar=mysql_query("SELECT * FROM emlak_ilan where firsatvitrin = '1' order by id DESC");
                    ...
                    <tr>
                    	...
                    	<th>
							<a href="index.php?do=islem&emlak=emlak_firsatvitrin&vitrin=onay&id=<?=$ilan["id"];?>" class="btn btn-default btn-xs btn-block" style="text-align: left;">
								<i class="fa fa-check" style="color: #0ac7ff;"></i> 
								<span>Fırsat Vitrini</span>
							</a>
						</th> 
                    	<th>
